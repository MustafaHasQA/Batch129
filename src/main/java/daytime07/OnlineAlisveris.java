...
public class OnlineAlisveris {
    ...
    private static void musteriSecim() {
        System.out.println("Lutfen sectiginiz urun kodunu giriniz");
        int secim= input.nextInt();
        System.out.println("Lutfen sectiginiz urunden kac adet istedginizi giriniz");
    ...
    private static void odeme() {
        ...
        if (date.isEqual(kurulusGunumuz)){
            ...
            System.out.println("Yine bekkleriz Odemeniz : " +toplamOdeme+"$");
    }//odeme()
}
