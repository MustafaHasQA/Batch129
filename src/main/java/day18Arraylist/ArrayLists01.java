...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        a.remove("shoes");
        System.out.println("a = " + a);//[tv, radio , laptop, shoes, book ,shoes]
        //5) Array Listimizde coklu datanin olupğ olmadigini nasil gösteririz ?
        // containAll() : bir listin icinde coklu elemanin olup olmadigini
        //kontol eder. hepsi varsa truw; en az bir tanesi yoksa false verir.
