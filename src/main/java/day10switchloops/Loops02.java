...
//           ankara ==> AnKaRa
        ...
        // Yazdiginiz kod belli senoryolar ıcın calısıyor , tum seneryolar ıcın calısmaıyorsa bu koda "HARD code"  denir.************
        // "Hard-code" yanlıs yazılmıs code'dir.mutlaka duzeltılmelıdır**********

        //note : Bir strıng'de son index = length() -1**********
        String s = "ankara";
