...
public class StringBuilder01 {
    ...
    public static void main(String[] args) {
        ...
        //method'lara ihtiyac duydugumuzda toString() method'unu kullanarak String Class gecer ce o method'lari kullaniriz.
        sb3.toString().split("l");

        //String'i tekrar StringBuilder'a cevirebilirsibniz.
        ...
        //deleteCharAt(1); index 1 deki charecter'i siler.
        sb3.deleteCharAt(1);
        ...
        //sb5.compareTo(sb6) methodu sb5 ile sb6 yi alfabetic siralama olarak karsilastirir.
        // sb5 alfabetik siralamada once ise sonuc negative olur ve sonra ise sonuc positive olur.
        System.out.println(sb5.compareTo(sb6));//1

        //sb6.setCharAt(2, 'm'); index 2 deki karakteri 'i' yi 'm' ye cevirir.
        sb6.setCharAt(2, 'm');
        ...
        // StringBuilder Class'ta kullanmamızda izin verilen subString() method gibibazi String Class methodlari vardir.
